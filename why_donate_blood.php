...
<div class="row">
    <div class="col-lg-6">
        ...
        <p>
          <?php
            $conn=mysqli_connect("localhost","root","","1life_admin") or die("Connection error");
    ...
    <div class="col-lg-6">
        ...
        <img class="img-fluid rounded" src="image\d2.jpeg" style="height:600px; width:500px" alt="error"  >
    </div>
