  ...
  <div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <img src="image\d2.jpeg" alt="d2.jpeg" width="100%" height="500">
                        </div>
                        ...
                        <div class="carousel-item">
                            <img src="image\d.jpeg" alt="d.jpeg" width="100%" height="500">
                        </div>
    ...
    <a class="carousel-control-prev" href="#demo" data-slide="prev">
                ...
                <br>
                <h1 style="text-align:center;font-size:45px;">Welcome to 1-Life Donation Management System</h1>
                <br>
        <div class="row">
            ...
            <div class="col-lg-4 mb-4">
             ...
             <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header card bg-info text-white">The need for fund</h4>

                    <p class="card-body overflow-auto" style="padding-left:2%;height:120px;text-align:left;">
                      <?php
                        include './admin/conn.php';
                        $sql=$sql= "select * from pages where page_type='needforfund'";
                        $result=mysqli_query($conn,$sql);
                        if(mysqli_num_rows($result)>0)   {
                            while($row = mysqli_fetch_assoc($result)) {
                              echo $row['page_data'];
...
<br>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <img class="img-fluid rounded" src="image\bd.jpg" alt="data" >
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <a class="btn btn-lg btn-secondary btn-block" href="donate_blood.php" style="align:center; background-color:#17a2b8;color:#FFFFFF ">Donate Blood </a>
                <a class="btn btn-lg btn-secondary btn-block" href="donate_fund.php" style="align:center; background-color:#17a2b8;color:#FFFFFF ">Donate Fund </a>
            </div>
        </div>
